...
//
    ...
    public function scopeCompromisoHallazgoProcesoAuditado($query) {
        return $query->select('id_seguimiento', 'c.id_compromiso', 'numero_informe', 'numero_informe_unidad', 'nombre_proceso_auditado', 'nombre_hallazgo', 'nombre_compromiso', 'seguimiento.estado', 'condicion', 'porcentaje_avance', 'plazo_comprometido')
