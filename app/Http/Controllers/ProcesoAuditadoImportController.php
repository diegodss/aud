...
use App\ProcesoAuditadoNomenclatura;
use App\ProcesoAuditadoImport;
use Excel;
use File;
use Session;

class ProcesoAuditadoImportController extends Controller {
    ...
    public function index($errorMsg = null, $returnData = null) {
        ...
        return View::make('proceso_auditado_import.upload', $returnData);
    }
    ...
    public function read($fileName) {
        ...
        $proceso_auditado_import = New ProcesoAuditadoImport();
        $proceso_auditado_import->documento_adjunto = $file;
        $proceso_auditado_import->descripcion = $fileName;
        $proceso_auditado_import->total = $total;
        $proceso_auditado_import->tipo_import = "Cambio de PMG";
        $proceso_auditado_import->usuario_registra = 1; // TODO Auth::user()->id;
        $proceso_auditado_import->save();
    ...
    public function tutorial(Request $request) {
        ...
        return View::make('proceso_auditado_import.tutorial', $returnData);
    }
