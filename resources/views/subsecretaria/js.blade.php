<script>
    ...
    $(document).ready(function () {
        ...
        $(function () {
            $('form[name=subsecretariaForm]').submit(function () {
                console.log($("#modal_input").val());
                is_modal = $("#modal_input").val();
                if (is_modal == "sim") {

                    $.post($(this).attr('action'), $(this).serialize(), function (json) {
                        $("#id_subsecretaria").append('<option value=' + json['id_subsecretaria'] + ' selected="selected">' + json['nombre_subsecretaria'] + '</option>');
                        //console.log(json['id_subsecretaria']);
