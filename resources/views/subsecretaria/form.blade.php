...
<div class="row">
    <div class="col-xs-6">
        <div class="form-group required">
            {!! Form::label('nombre_subsecretaria', 'Nombre Subsecretaria:') !!}
            {!! Form::text('nombre_subsecretaria',null,['class'=>'form-control' ]) !!}
        </div>
        <div class="form-group required">
            {!! Form::label('rut_completo', 'Rut Subsecretaria:') !!}
            {!! Form::text('rut_completo',null,['class'=>'form-control', 'id'=>'rut_completo']) !!}
        </div>
        <div class="form-group">
            {!! Form::label('id_ministerio', 'Ministerio:') !!}
            {!! Form::select('id_ministerio',[null=>'Seleccione'] +$ministerio, $subsecretaria->id_ministerio, array('id'=> 'id_ministerio' , 'class'=>'form-control') ) !!}
        </div>
        <div class="form-group required">
            {!! Form::label('nombre_subsecretario_a', 'Nombre Subsecretario(a):') !!}
            {!! Form::text('nombre_subsecretario_a',null,['class'=>'form-control']) !!}
        </div>
        <div class="form-group" >
        ...
        <div class="form-group">
            ...
            {!! Form::checkbox('fl_status', '1', $subsecretaria->fl_status , ['class'=>'form-control_none', 'id'=>'fl_status', 'data-size'=>'mini']) !!}
        </div>
    </div>
    <div class="col-xs-6">
        <div class="form-group">
...
<div class = "form-group text-right">
    <?php if ((isset($modal)) && ($modal == "sim")) {
        ...
        ?><a href="{{ url('subsecretaria')}}" class="btn btn-primary">Volver</a><?php
    }
